...
import { generateQuizPronounsFindError } from "../../../API/PronounApi";
...
const FindErrorPronouns = () => {
  ...
  const handleStartQuiz = async () => {
    ...
    try {
      const response = await generateQuizPronounsFindError({
        type: "FindErrorPronouns",
...
export default FindErrorPronouns;
