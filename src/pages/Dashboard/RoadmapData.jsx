export const rawRoadmap = [
  {
    ...
    days: [
      { id: "w1-d1", title: "Thứ 2", focus: "Ngữ pháp: Danh từ & Đại từ", tasks: [{ id: "w1-d1-t1", type: "vocab", text: "Học 15-20 từ vựng TOEIC theo chủ đề", maxProgress: 5 }, { id: "w1-d1-t2", type: "theory", text: "Học lý thuyết Danh từ & Đại từ" }, { id: "w1-d1-t3", type: "quiz", text: "Giải 20-30 câu Part 5 & 6" }] },
      { id: "w1-d2", title: "Thứ 3", focus: "Động từ & Các thì cơ bản", tasks: [{ id: "w1-d2-t1", type: "vocab", text: "Học 15-20 từ vựng TOEIC theo chủ đề", maxProgress: 5 }, { id: "w1-d2-t2", type: "theory", text: "Học Động từ & Các thì cơ bản" }, { id: "w1-d2-t3", type: "quiz", text: "Giải 20-30 câu Part 5 & 6" }] },
      { id: "w1-d3", title: "Thứ 4", focus: "Tính từ & Trạng từ", tasks: [{ id: "w1-d3-t1", type: "vocab", text: "Học 15-20 từ vựng TOEIC theo chủ đề", maxProgress: 5 }, { id: "w1-d3-t2", type: "theory", text: "Học Tính từ & Trạng từ" }, { id: "w1-d3-t3", type: "quiz", text: "Giải 20-30 câu Part 5 & 6" }] },
      { id: "w1-d4", title: "Thứ 5", focus: "Sự hòa hợp giữa Chủ ngữ và Động từ", tasks: [{ id: "w1-d4-t1", type: "vocab", text: "Học 15-20 từ vựng TOEIC theo chủ đề", maxProgress: 5 }, { id: "w1-d4-t2", type: "theory", text: "Học Sự hòa hợp giữa Chủ ngữ và Động từ" }, { id: "w1-d4-t3", type: "quiz", text: "Giải 20-30 câu Part 5 & 6" }] },
