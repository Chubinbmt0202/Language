...
import { 
  RightOutlined, 
  SelectOutlined,       // Icon cho Chọn từ
  UnorderedListOutlined,// Icon cho Trắc nghiệm
  SearchOutlined,       // Icon cho Tìm lỗi sai
  UserOutlined,
  FileTextOutlined,
  HeartOutlined,
  HeartFilled
...
export const PronounsMenu = () => {
  ...
  const content = [
    { 
      id: "p1", 
      title: "Chọn đại từ (Choose Correct)", 
      path: "choose-pronouns", 
      icon: <SelectOutlined />,
      desc: "Lựa chọn đại từ nhân xưng, sở hữu hoặc phản thân phù hợp ngữ cảnh.",
      level: "Basic",
      participants: 1320,
      questionCount: 200
    },
    { 
      ...
      desc: "Bộ câu hỏi trắc nghiệm tổng hợp về các loại đại từ trong tiếng Anh.",
      level: "Intermediate",
      participants: 1560,
      questionCount: 350
    },
    { 
      id: "p3", 
      title: "Tìm lỗi sai (Find Errors)", 
      path: "find-errors", 
      icon: <SearchOutlined />,
      desc: "Phát hiện việc sử dụng sai đại từ trong đoạn văn và sửa lại.",
      level: "Advanced",
      participants: 840,
      questionCount: 120
    },
  ...
  return (
    <div style={{ padding: "0 24px" }}>
      ...
      <div style={{ marginBottom: 32 }}>
        <Title level={2} style={{ margin: 0 }}>Luyện tập Đại từ (Pronouns)</Title>
        <Text type="secondary">Sử dụng thành thạo I, Me, My, Mine, Myself...</Text>
      </div>
