...
import { 
  RightOutlined, 
  EditOutlined,        // Icon cho điền từ
  FontSizeOutlined,    // Icon cho hậu tố
  CloseCircleOutlined, // Icon cho tìm lỗi sai
  UserOutlined,
  FileTextOutlined,
  HeartOutlined,
  HeartFilled
...
export const WordFormMenu = () => {
  ...
  const content = [
    { 
      ...
      icon: <EditOutlined />,
      desc: "Lựa chọn từ loại thích hợp (Danh/Động/Tính) để hoàn thành câu.",
      level: "Basic",
      participants: 1250,
      questionCount: 150
    },
    { 
      id: "wf2", 
      title: "Bài tập hậu tố (Suffixes)", 
      path: "suffix-exercise", 
      icon: <FontSizeOutlined />,
      desc: "Biến đổi từ bằng các hậu tố phổ biến (-tion, -ment, -ness, -ity).",
      level: "Intermediate",
      participants: 890,
      questionCount: 120
    },
    { 
      ...
      desc: "Phát hiện từ dùng sai loại trong câu văn và sửa lại cho đúng.",
      level: "Advanced",
      participants: 640,
      questionCount: 80
    },
  ...
  return (
    <div style={{ padding: "0 24px" }}>
      ...
      <div style={{ marginBottom: 32}}>
        <Title level={2} style={{ margin: 0 }}>Luyện tập Từ loại (Word Form)</Title>
        <Text type="secondary">Nắm vững cách cấu tạo từ và vị trí trong câu</Text>
      </div>
